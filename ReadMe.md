...
| :---- | :---- | :---- |
| **Average Calculator** | Computes the average of 3 grades with validation. | int.TryParse, do-while, String Interpolation |
| **\[Project Name\]** | *\[Brief description of next project\]* | *\[Key concepts used\]* |
| **\[Project Name\]** | *\[Brief description of next project\]* | *\[Key concepts used\]* |
...
* **Portfolio:** [zdeveloper.online](https://zdeveloper.online)  
